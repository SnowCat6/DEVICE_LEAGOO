...
CUSTOM_HAL_MSENSORLIB = mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md qmc5983 akmd09911 mc64xx bmm056 mc41xx memsicd3524x
CUSTOM_HAL_SENSORS = sensor
CUSTOM_KERNEL_ACCELEROMETER = yes
CUSTOM_HAL_GSENSORLIB = memsicp
...
CUSTOM_MODEM = t591_g4_w1258_hspa
...
MTK_BUILD_VERNO = alps-mp-n0.mp2-V1_wtk6580.we.n_P11
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#CREATE_PROJECT_INFO=2016101710138
#WTK Begin For Driver--------------------------------------------------------------------------------
# LOGO:==========
#BOOT_LOGO = t592_otd_p1_kiicaan_hd720
# LCM:===========
...
# lisong 2015-7-14 [BUGID:NULL][multi lcm resolution compatible]start
RGK_LCM_RES_COMPATIBLE = yes
...
#HD720 1280x720
BOOT_LOGO2 = t592_otd_p1_kiicaan_hd720
BASE_LOGO2 = hd720
...
BOOT_LOGO5 = cu_wvga
BASE_LOGO5 = wvga
# lisong 2015-7-14 [BUGID:NULL][multi lcm resolution compatible]end
#End For Driver----------------------------------------------------------------------------------


# CAMERA:=============
#CUSTOM_HAL_IMGSENSOR = sp2509_mipi_raw sp25090_mipi_raw sp5506_mipi_raw gc5025_mipi_raw gc2375_mipi_raw gc23750_mipi_raw gc030a_mipi_raw
#CUSTOM_HAL_MAIN_IMGSENSOR = sp5506_mipi_raw gc5025_mipi_raw
#CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
#CUSTOM_HAL_SUB_IMGSENSOR = sp2509_mipi_raw  gc2375_mipi_raw gc23750_mipi_raw sp25090_mipi_raw gc030a_mipi_raw
#CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
#CUSTOM_HAL_MAIN2_IMGSENSOR = gc23750_mipi_raw  

#CUSTOM_KERNEL_IMGSENSOR = sp2509_mipi_raw sp25090_mipi_raw sp5506_mipi_raw gc5025_mipi_raw gc2375_mipi_raw gc23750_mipi_raw gc030a_mipi_raw
#CUSTOM_KERNEL_MAIN_IMGSENSOR = sp5506_mipi_raw gc5025_mipi_raw
#CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
#CUSTOM_KERNEL_SUB_IMGSENSOR = sp2509_mipi_raw gc2375_mipi_raw gc23750_mipi_raw sp25090_mipi_raw gc030a_mipi_raw
#CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
#CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
#CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc23750_mipi_raw

WTK_MAIN2_SURPPORT=yes
...
# WTK add begin
WTK_BUILD_VERNO = LEAGOO_KIICAA POWER_R3_16_N_OS3.0 Lite_20180131
WTK_INTERNAL_BUILD_VERNO = T591_OTD_KIICAA_N_V0.2.3_S180131

# WTK add end
#add by chenxuanyu start
#SW_SW9251_FINGERPRINT = yes
#MA_AFS080U_FINGERPRINT = yes
#add by chenxuanyu end
#add by jinhui.li start
WTK_CAMERA_COVERED_SWITCH = no
...
#adupsfota end
#add by jinhui.li for camera bokeh
GANGYUN_BOKEH_SUPPORT = yes
#add by jinhui.li for camera bokeh

#A:TWJY-577 lidongdong start 20170112 {
WTK_LED_SETTING = yes
#A: TWJY-577 end }

#A: XWLJL-149 chong.zha 20161202 {
WTK_APP_WAKE_GESTURE_SUPPORT = yes
#A: XWLJL-149 }
#add BUG_ID:TWJY-1326 liuzhijun 20170410 (start)
WTK_CAMERA_SUPPORT = yes
GANGYUN_CAMERA_BEAUTY = yes

WTK_BUILD_FINGERPRINT = LEAGOO/KIICAA_POWER/KIICAA_POWER:7.0/NRD90M/1512480092:user/release-keys


#add BUG_ID:TWJY-1326 liuzhijun 20170410 (end)
# add by jinhui.li for mtp {
WTK_DEFAULT_MTP = yes
# add by jinhui.li }
#add by jinhui.li for FreemeLiteOs start
FREEMEOS_VER = 7.0
FREEMEOS_LAB = FreemeOS
FREEMEOS_CH	= Wheatek
FREEMEOS_CUS = OTD
FREEMEOS_BRA = $(PRODUCT_BRAND)
FREEMEOS_CBRA =	
#add by jinhui.li for FreemeLiteOs end
# add by wuzhi.peng for fingerprint  -- modify 170615 remove fingerprint
#CDFINGERPRINT_FINGERPRINT = no
# add by wuzhi.peng for fingerprint
# add TWJE-44 by jinhui.li  {
WTK_REMOVE_CTA_ECC_LIST_SUPPORT = yes
# add TWJE-44 by jinhui.li  }

#add by yangyin for TWJE-47 20170607 start
WTK_BASEBAND_VERSION = LEAGOO KIICAA POWER_OS3.0 Lite
WTK_KERNEL_VERSION = LEAGOO KIICAA POWER_OS3.0 Lite
#add by yangyin for TWJE-47 20170607 end

#add BUG_ID:TWBLN-166 hu.liu 20170310 (start)
PHOTO_TABLE_VIDEO_SUPPORT = yes
#add BUG_ID:TWBLN-166 hu.liu 20170310 (end)

#add by yangyin for TWJE-139 20170621 start
WTK_BOOT_VIBR_ENABLE = yes
#add by yangyin for TWJE-139 20170621 end

#A:TWJE-179 yang.chen 20170621 {
MTK_BACKUPWITHRESTORE_APP = no
#A:TWJE-179 }

#add by yangyin start for cts
WTK_MAIN2_CTS_SUPPORT = yes
#add by yangyin end for cts

#add by chenxuanyu start
#CD_FINGER_TEE_FINGERPRINT = yes
CD_FINGER958E_TEE_FINGERPRINT = yes
MADEV_A96_TEE_FINGERPRINT=yes
WTK_TRUSTONIC_TEE_DOUJIA_SUPPORT = yes
#add by chenxuanyu end
WTK_MULTISIM_RINGTONE_SUPPORT = yes

#add by wuzhi.peng for  TWJY-2056 start 
WTK_MTP_LABEL = KIICAA POWER
WTK_PTP_LABEL = KIICAA POWER
#add by wuzhi.peng for TWJY-2056 end
...
#USE_SEARCH_LAUNCHER3 = yes
#add by yangyin for fastpass end
#add by chenxuanyu for gms start
WTK_CHROME_WITHOUT_MtkBrowser = yes
WTK_GMAIL_WITHOUT_EMAIL = yes
WTK_PHOTO_WITHOUT_Gallery2 = yes
WTK_Music2_WITHOUT_WtkMusic = yes
#add by chenxuanyu for gms ernd
REMOVE_ORIGIN_CALENDAR = yes
REMOVE_ORIGIN_MESSAGING = yes
